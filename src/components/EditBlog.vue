...
<script>
	export default{
		...
		methods:{
			...
			post:function(){
				 this.$http.put('https://my-blog-96629.firebaseio.com/posts/'+this.id+'.json',this.blog)
				 .then(function(data){
				 	console.log(data);
				 	this.submmited=true;
				 });
...
<style scoped>
	...
	#checkboxes label{display: inline-block;margin-top:0px ;}
